            ...
            <div className="flex flex-col justify-center gap-5 p-5 sm:gap-24 sm:py-10 lg:flex-row">
              <div className="order-1 flex w-full flex-col justify-center gap-5 transition-all duration-500 lg:-order-1 lg:w-1/3 opacity-100">
                ...
                <p className="text-base leading-8 text-white/90 sm:mt-2 sm:text-2xl transition-all duration-300">
                  تعلّم، طوّر، وابتكر من أي مكان في العالم.
                </p>
                <Link
                  className="w-fit justify-start sm:mt-5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#aa7fff] rounded-2xl transition-all duration-300 group relative overflow-hidden"
                  href="/"
                  tabIndex={0}
                >
                  <Button
                    ...
                    asChild
                  >
                    <span className="relative z-20 tracking-wide">ابدأ الآن!</span>
                  </Button>
