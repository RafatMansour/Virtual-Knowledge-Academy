...
export const metadata = {
  title: 'المحتوى التعليمي - أكاديمية المعرفة الإفتراضية',
};
        ...
        <Protected>
          <section className="bg-gradient-to-r from-[#7CB5EB] via-[#aa7fff] to-[#aa7fff] dark:from-[#3B3371] dark:via-[#443266] dark:to-[#443266] pt-28 sm:pt-36 pb-10">
            <div className="container mx-auto sm:max-w-[69rem] px-5">
              <h1 className="text-3xl sm:text-5xl font-extrabold text-white drop-shadow-md">المحتوى التعليمي</h1>
              <p className="mt-3 text-white/90 text-base sm:text-xl">اكتشف المقالات والدروس المصممة لدعم تعلمك.</p>
            </div>
          </section>
